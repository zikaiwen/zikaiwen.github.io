...
Hi, there! I'm a researcher in human-centered computing dedicated to fostering **Safe and Engaging Youth-AI Interactions**. My mission is to enhance the way young users (i.e., children, teenagers, and special education students) interact with AI agents. My research targets two essential objectives: (1) ensuring their privacy and security in AI engagements and (2) removing accessibility hurdles for those with neurodevelopmental disabilities. These key objectives guide my efforts to design AI agents that are safer and more inclusive, addressing the unique needs of our younger population. My research has been published at prestigious CS conferences such as ACM CHI, ACM ASSETS, ACM CCS, and IEEE S&P.

I am a postdoctoral researcher in the Computer Science Department at [Virginia Tech](https://website.cs.vt.edu/), working with [Prof. Yaxing Yao](http://yaxingyao.com/). I am fortunate to have worked as a postdoc at [the HKUST Visualization Lab](http://vis.cse.ust.hk/vislab_homepage/people.html). I received my Ph.D. degree in computer science from [Cornell University](https://www.cs.cornell.edu/). Before that, I recieved my joint First-class Honours bachelor degree in computer science from [University of Strathclyde, Glasgow, U.K.](https://www.strath.ac.uk/) and [BUCT, Beijing, China](https://www.buct.edu.cn/main.htm).
...
| **IEEE GEM'22** | [What Features Influence Impact Feel? A Study of Impact Feedback in Action Games](articles/linfeatures22.pdf)  | Zhonghao Lin, [Haihan Duan](https://seaxiaod.gitee.io), **Zikai Alex Wen**, [Wei Cai](https://mypage.cuhk.edu.cn/academics/caiwei/) | Gaming |
