...
Hi there! I am a **human-computer interaction (HCI)** researcher with a robust focus on **privacy and security**. My current research explores how users, especially adolescents, engage with emerging communication technologies like AI agents, social VR, and short video platforms. Recognized at leading CS conferences and journals such as ACM CHI, Information Sciences, ACM CCS, and IEEE S&P, my work is driven by two pivotal goals: enhancing user digital privacy and security, and empowering users with knowledge on digital self-protection. I employ user-centered design and advanced privacy frameworks to ensure safe digital interactions, particularly for young users.
