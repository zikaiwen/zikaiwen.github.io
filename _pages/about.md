...
My research centers around **data-centric AI**, encompassing **interaction**, **analysis**, **safety**, and **management** aspects. I am dedicated to understanding and resolving the challenges that emerge when AI technologies intersect with human interactions, data analysis, and cybersecurity measures in practical applications. My scholarly contributions, including publications at prestigious computer science conferences such as ACM CHI, ACM ASSETS, IEEE S&P, and ACM CCS, consistently underline the vital role of data in shaping and securing AI. Besides academic pursuits, I engage actively with Fortune 500 companies to transition AI from a research concept into an operational reality, emphasizing the importance of data-centric approaches in the contemporary AI landscape.
