...
Hi there! I am a **human-computer interaction (HCI)** researcher specializing in **usable privacy and security**. My work focuses on protecting users, especially adolescents, as they communicate through online platforms such as emails, gaming, decentralized social media, and AI agents. I aim to (1) enhance the usability of digital privacy/security and (2) empower users with self-protection skills. I leverage user-centered research methods and theoretical privacy frameworks to drive innovation and achieve my goals. My research has been published in leading computer science conferences and journals such as ACM CHI, Information Sciences, ACM CCS, and IEEE S&P.
