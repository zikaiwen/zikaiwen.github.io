...
Hi there! I am a **human-computer interaction (HCI) and privacy** researcher. My research focuses on identifying and addressing privacy and security issues that affect users, particularly adolescents, as they interact with communication technologies such as social media, emails, and AI agents. My work is driven by two pivotal goals: (1) enhancing users' digital privacy and security and (2) equipping users with the knowledge for self-protection in the digital world. I employ user-centered design and advanced privacy frameworks to achieve my goals. My research has been published in leading CS conferences and journals such as ACM CHI, Information Sciences, ACM CCS, and IEEE S&P.
