...
Hi there! As a **human-computer interaction (HCI)** researcher specializing in **usable privacy and security**, I advance digital safety in cyber ecosystems through human-centered methods. I focus on two complementary areas: digital safety education and human-AI interaction safety. The former area proactively empowers individuals with the knowledge and skills to navigate digital spaces securely, while the latter area focuses on developing defenses against emerging AI-driven threats. By integrating computer science and developmental psychology, I work to strengthen human capabilities in cybersecurity through both proactive education and reactive defense mechanisms. My research has been published in leading research venues including ACM CHI, Information Sciences, and ACM CCS. More specifically, my recent research projects include:
