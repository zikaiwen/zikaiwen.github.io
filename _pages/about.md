...
Hi there! I am a **human-computer interaction (HCI)** researcher with a robust focus on challenges in **usable privacy and security**. My research is dedicated to protecting users, particularly adolescents, as they interact with communication tech such as online games, emails, and AI agents. My work is driven by two goals: (1) enhancing users' digital privacy and security and (2) equipping users with the knowledge for self-protection in the digital world. I employ the user-centered research method and theoretical privacy frameworks to achieve my goals. My research has been published in leading computer science conferences and journals such as ACM CHI, Information Sciences, ACM CCS, and IEEE S&P.
