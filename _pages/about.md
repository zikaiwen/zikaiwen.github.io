...
Hi there! I am a **human-computer interaction (HCI)** researcher specializing in **usable privacy and security**. My work focuses on protecting users, especially teenagers, from privacy, security, and safety threats across Internet platforms like email, online games, and AI agents. My research aims to: (1) enhance the usability of digital privacy and security measures, and (2) empower users with essential self-protection skills. To achieve these goals, I employ user-centered research methods and leverage theoretical privacy frameworks. My research has been published in leading computer science venues including ACM CHI, Information Sciences, ACM CCS, and IEEE S&P.
